...
parser.add_argument('--test_data_dir', type=str, metavar='PATH',
                    default='/media/zj/新加卷/ubuntu/projects/aster.pytorch/data/visiual_data/val/')#/share/zhui/reg_dataset/IIIT5K_3000
...
parser.add_argument('--voc_type', type=str, default='ALLCASES_SYMBOLS',
                    choices=['LOWERCASE', 'ALLCASES', 'ALLCASES_SYMBOLS','Traffic_Sign'])
...
# training configs
parser.add_argument('--resume', type=str, default='/media/zj/新加卷/ubuntu/projects/aster.pytorch/demo.pth.tar', metavar='PATH')
parser.add_argument('--evaluate', action='store_true',
                    help="evaluation only")
parser.add_argument('--epochs', type=int, default=10)#6
...
parser.add_argument('--beam_width', type=int, default=5)#5
# misc
